...
glm::mat4 Bone::InterpolateRotation(float animationTime)
{
	...
	const glm::quat finalRotation = glm::normalize(glm::slerp(m_Rotations[p0Index].orientation, m_Rotations[p1Index].orientation, scaleFactor));
